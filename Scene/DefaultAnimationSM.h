...
struct DefaultAnimationSM : public Component
{
	...
	AnimationSlot* setAnimationNew(
		...
		PrimitiveTypes::Bool useProgressPercentageOfReplacedAnimation = true,
		PrimitiveTypes::Float32 customPercentage = 0.0f,
		PrimitiveTypes::UInt32 start_Joint = 0,
		PrimitiveTypes::UInt32 end_Joint = 48);
	...
	std::string m_upperbody_Animation;
	std::string m_downbody_Animation;
