...
struct DebugRenderer : public SceneNode
{
	...
	void createLineBoundingBox(const Matrix4x4& transform, float* AABB);
	void createDebugCollider(PhysicsComponent* phy_comp);
	...
	private:
		...
		static const int NUM_LineLists = (50 * 1024);
