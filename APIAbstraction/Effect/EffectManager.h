...
struct EffectManager : public PE::PEAllocatableAndDefragmentable
{
	...
	void setGBufferTextureForDeferredRendering();
	...
	void drawDeferredLightPass();
	void UpdateDeferredLightMap(GLubyte* updateinfo);

	void drawGBuffer();

	void debugDrawRenderTarget(bool drawGlowRenderTarget, bool drawSeparatedGlow, bool drawGlow1stPass, bool drawGlow2ndPass, bool drawShadowRenderTarget, bool drawGBufferDebug);
...
public:
	...
	Handle m_hGBufferTextureGPU_pos;
	Handle m_hGBufferTextureGPU_normal;
	Handle m_hGBufferTextureGPU_albedo;
	Handle m_hGBufferTextureGPU_specular;
	Handle m_hGBufferTextureGPU_depth;

	Handle m_hDefferedLightMaskTextureGPU;

	Handle m_hGBufferTextureGPU;
...
public:
	...
	Handle m_hGBufferEffect;
	Handle m_hGBufferSkinEffect;
	Handle m_hDeferredLightingEffect;
