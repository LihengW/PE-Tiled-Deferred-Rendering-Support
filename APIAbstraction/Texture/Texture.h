...
struct TextureGPU : PE::PEAllocatableAndDefragmentable
{
	...
	void createGBufferRenderTarget(PrimitiveTypes::UInt32 w, PrimitiveTypes::UInt32 h, ESamplerState sampler);
	void createDeferredLightMaskTexture(PrimitiveTypes::UInt32 w, PrimitiveTypes::UInt32 h, ESamplerState sampler);
