...
EPEVertexFormat getFormatFromVSName(const char *vsFilename)
{
	...
	if (StringOps::startsswith(vsFilename, "GBufferWrite_"))
		return PEVertexFormat_DetailedMesh;
	if (StringOps::startsswith(vsFilename, "GBufferWriteSkin_"))
		return PEVertexFormat_DetailedSkin;
	if (StringOps::startsswith(vsFilename, "DeferredLightShading_"))
		return PEVertexFormat_DeferredRender;
